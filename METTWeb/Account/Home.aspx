                                          ...
                                          var ContentDiv = CardDiv.Helpers.DivC("ibox-content");
                                          {
                                              var RowContentDiv = ContentDiv.Helpers.DivC("row");
                                              {
                                                  var LeftColContentDiv = RowContentDiv.Helpers.DivC("col-md-12 text-center");
                                                  {
                                                      ...
                                                      {
                                                          //ProfileDiv.Helpers.Span(c => c.Balance);
                                                      ...
                                                      // Place Content Here EDITED
                                                      // LeftColContentDiv.Helpers.HTML("<h1>{ Balance }</h1>");
                                                      LeftColContentDiv.Helpers.ReadOnlyFor(c => c.UserAccount.Balance);
                                                      //LeftColContentDiv.Helpers.HTML("<h2>{ Full Name }</h2>");
                                                      LeftColContentDiv.Helpers.Span(c => c.LoggedInUserName);
