...
namespace MELib.Movies
{
     ...
     : SingularBusinessBase<Movie>
    {
        ...
        /// </summary>
        [Display(Name = "Movie Genre", Description = "Foreign Key - Movie Genre ID"),
        ...
        public static PropertyInfo<String> MovieImageURLProperty = RegisterProperty<String>(c => c.MovieImageURL, "Movie Image URL", "../Media/Movies/blank.jpg");
        /// <summary>
