...
{
    [Serializable]
    public class ROProductPaged
     : SingularReadOnlyBase<ROProductPaged>
    {
        ...
        internal static ROProductPaged GetROProductPaged(SafeDataReader dr)
        {
            var r = new ROProductPaged();
            r.Fetch(dr);
            return r;
        }
